...
class CfcClient(bce_base_client.BceBaseClient):
    ...
    def update_function_code(self, function_name, zip_file=None,
        ...
        :param dry_run  This boolean parameter can be used to test.txt your request to CFC to update the function and
        ...
        :return:  message result as following format
            {
                "Relation": {
                    ...
                    "Source": "string",
                    "Target": "brn:bce:cfc:bj:640c8817bd1de2928d47256dd0620ce5:function:test.txt:$LATEST",
                    "Data": {
